...
public class RentalSystemGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    if ((rentalSystem instanceof RentalSystem)) {
      ...
      String _plus_2 = ("src/main/java/" + _firstUpper_1);
      String _plus_3 = (_plus_2 + "Controller.java");
      CharSequence _generateErrorController = this.generateErrorController(((RentalSystem)rentalSystem));
      fsa.generateFile(_plus_3, _generateErrorController);
      String _name_2 = ((RentalSystem)rentalSystem).getName();
      String _firstLower = StringExtensions.toFirstLower(_name_2);
      String _plus_4 = ("src/main/webapp/WEB-INF/views/jsp/" + _firstLower);
      String _plus_5 = (_plus_4 + ".jsp");
      CharSequence _generateIndexJsp = this.generateIndexJsp(((RentalSystem)rentalSystem));
      fsa.generateFile(_plus_5, _generateIndexJsp);
      CharSequence _generateErrorPageJsp = this.generateErrorPageJsp(((RentalSystem)rentalSystem));
      fsa.generateFile("src/main/webapp/WEB-INF/views/jsp/errorPage.jsp", _generateErrorPageJsp);
      ...
      String _name_3 = ((RentalSystem)rentalSystem).getName();
      ...
      fsa.generateFile(_plus_7, _generateIndexController);
      ...
      for (final Customer customer : _customers) {
        {
          ...
          String _plus_8 = ("src/main/java/" + _firstUpper_3);
      ...
      for (final RentalType rentalType : _rentalTypes) {
        {
          ...
          fsa.generateFile(_plus_9, _generateRentalTypeBeans);
          ...
          fsa.generateFile(_plus_11, _generateRentalTypeRepos);
          ...
          fsa.generateFile(_plus_13, _generateRentalTypeJsp);
          ...
          fsa.generateFile(_plus_15, _generateRentalTypeFormJsp);
          ...
          fsa.generateFile(_plus_17, _generateRentalTypeController);
        }
      }
      ...
      for (final Deal deal : _deals) {
        {
          ...
          fsa.generateFile(_plus_17, _generateDealController);
          String _name_9 = deal.getName();
          String _firstLower_3 = StringExtensions.toFirstLower(_name_9);
          String _plus_18 = ("src/main/webapp/WEB-INF/views/jsp/" + _firstLower_3);
          String _plus_19 = (_plus_18 + "StatesIndex.jsp");
          CharSequence _generateWorkflowsIndexJsp = this.generateWorkflowsIndexJsp(((RentalSystem)rentalSystem), deal);
          fsa.generateFile(_plus_19, _generateWorkflowsIndexJsp);
          ...
          for (final State state : _states) {
            {
              ...
              fsa.generateFile(_plus_31, _generateDealStateBeans);
            }
          }
        }
      }
  ...
  public CharSequence generateErrorController(final RentalSystem rentalSystem) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package de.nordakademie.xtext.hausarbeit.rentalSystem.web;");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public class IndexController implements ErrorController{");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("private static final String PATH = \"/error\";");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("@RequestMapping(value = PATH)");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("public String error() {");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("return \"errorPage\";");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("public String getErrorPath() {");
    _builder.newLine();
    _builder.append("\t        ");
  ...
  public CharSequence generateDealController(final Deal deal, final RentalSystem rentalSystem) {
    ...
    _builder.append("Repository startStateRepository;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.append("ModelAndView mav = new ModelAndView(\"");
    String _name_10 = deal.getName();
    String _firstLower_2 = StringExtensions.toFirstLower(_name_10);
    _builder.append(_firstLower_2, "\t\t\t");
    _builder.append("\");");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    ...
    _builder.append(_firstLower_4, "\t\t\t");
    RentalWorkflow _rentalWorkflow_2 = deal.getRentalWorkflow();
    EList<State> _startState_2 = _rentalWorkflow_2.getStartState();
    State _head_2 = IterableExtensions.<State>head(_startState_2);
    String _name_13 = _head_2.getName();
    String _firstUpper_8 = StringExtensions.toFirstUpper(_name_13);
    ...
    _builder.append(_firstLower_5, "\t\t\t\t");
    RentalWorkflow _rentalWorkflow_3 = deal.getRentalWorkflow();
    EList<State> _startState_3 = _rentalWorkflow_3.getStartState();
    State _head_3 = IterableExtensions.<State>head(_startState_3);
    EList<State> _transition = _head_3.getTransition();
    State _head_4 = IterableExtensions.<State>head(_transition);
    String _name_15 = _head_4.getName();
    ...
    String _name_28 = _rentalType_3.getName();
    String _firstUpper_14 = StringExtensions.toFirstUpper(_name_28);
    _builder.append(_firstUpper_14, "\t\t\t\t");
    _builder.append("(");
    RentalType _rentalType_4 = deal.getRentalType();
    String _name_29 = _rentalType_4.getName();
    String _firstLower_14 = StringExtensions.toFirstLower(_name_29);
    ...
    String _firstLower_15 = StringExtensions.toFirstLower(_name_30);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("// Nun den erstellten Deal dem ersten State zuweisen");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(!startStateRepository.findAll().iterator().hasNext()){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("startState = new ");
    String _name_31 = deal.getName();
    String _firstUpper_15 = StringExtensions.toFirstUpper(_name_31);
    _builder.append(_firstUpper_15, "\t\t\t\t\t");
    RentalWorkflow _rentalWorkflow_4 = deal.getRentalWorkflow();
    EList<State> _startState_4 = _rentalWorkflow_4.getStartState();
    State _head_5 = IterableExtensions.<State>head(_startState_4);
    String _name_32 = _head_5.getName();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("startState = startStateRepository.findAll().iterator().next();");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("> dealsList;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("if(startState.get");
    String _name_34 = deal.getName();
    String _firstUpper_18 = StringExtensions.toFirstUpper(_name_34);
    _builder.append(_firstUpper_18, "\t\t\t\t");
    _builder.append("List() != null){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t");
    _builder.append("dealsList = startState.get");
    String _name_35 = deal.getName();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("dealsList = new ArrayList<");
    String _name_36 = deal.getName();
    String _firstUpper_20 = StringExtensions.toFirstUpper(_name_36);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("dealsList.add(");
    String _name_37 = deal.getName();
    String _firstLower_16 = StringExtensions.toFirstLower(_name_37);
    _builder.append(_firstLower_16, "\t\t\t\t");
    _builder.append(");");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("startState.set");
    String _name_38 = deal.getName();
    String _firstUpper_21 = StringExtensions.toFirstUpper(_name_38);
    _builder.append(_firstUpper_21, "\t\t\t\t");
    _builder.append("List(dealsList);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("startStateRepository.save(startState);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("ModelAndView mav = new ModelAndView(\"");
    String _name_39 = deal.getName();
    String _firstLower_17 = StringExtensions.toFirstLower(_name_39);
    ...
    _builder.append("\t\t");
    _builder.append("@RequestMapping(value=\"/");
    String _name_40 = deal.getName();
    String _firstLower_18 = StringExtensions.toFirstLower(_name_40);
    _builder.append(_firstLower_18, "\t\t");
    _builder.append("Form\", method=RequestMethod.GET)");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("public ModelAndView ");
    String _name_41 = deal.getName();
    String _firstLower_19 = StringExtensions.toFirstLower(_name_41);
    _builder.append(_firstLower_19, "\t\t");
    _builder.append("ShowForm(){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("ModelAndView mav = new ModelAndView(\"");
    String _name_42 = deal.getName();
    String _firstLower_20 = StringExtensions.toFirstLower(_name_42);
    ...
    _builder.append("\t\t");
    _builder.append("@RequestMapping(value=\"/");
    String _name_43 = deal.getName();
    String _firstLower_21 = StringExtensions.toFirstLower(_name_43);
    _builder.append(_firstLower_21, "\t\t");
    _builder.append("StatesIndex\")");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("public ModelAndView ");
    String _name_44 = deal.getName();
    String _firstLower_22 = StringExtensions.toFirstLower(_name_44);
    _builder.append(_firstLower_22, "\t\t\t");
    _builder.append("ShowStateIndex(){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("ModelAndView mav = new ModelAndView(\"");
    String _name_45 = deal.getName();
    String _firstLower_23 = StringExtensions.toFirstLower(_name_45);
  ...
  public CharSequence generateDealStateController(final Deal deal, final RentalSystem rentalSystem, final State state) {
    ...
    String _firstUpper_3 = StringExtensions.toFirstUpper(_name_3);
    _builder.append(_firstUpper_3, "\t\t");
    _builder.append("Repository stateRepository;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    State _head = IterableExtensions.<State>head(_transition);
    String _name_5 = _head.getName();
    String _firstUpper_5 = StringExtensions.toFirstUpper(_name_5);
    _builder.append(_firstUpper_5, "\t\t");
    _builder.append("Repository nextStateRepository;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("// Alle fuer diesen State vorhandenen Deals erfassen");
    _builder.newLine();
    _builder.append("\t\t\t");
    String _name_12 = deal.getName();
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("if(stateRepository.findAll().iterator().hasNext()){");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("state = stateRepository.findAll().iterator().next();");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(state.get");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t");
    _builder.append("dealsList = state.get");
    String _name_16 = deal.getName();
    String _firstUpper_13 = StringExtensions.toFirstUpper(_name_16);
    _builder.append(_firstUpper_13, "\t\t\t\t\t");
    _builder.append("List();");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t");
    _builder.append("mav.addObject(\"deals\", dealsList);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("@RequestMapping(value=\"/");
    String _name_17 = deal.getName();
    String _firstLower_3 = StringExtensions.toFirstLower(_name_17);
    _builder.append(_firstLower_3, "\t\t");
    String _name_18 = state.getName();
    String _firstUpper_14 = StringExtensions.toFirstUpper(_name_18);
    _builder.append(_firstUpper_14, "\t\t");
    _builder.append("MoveDeals\")");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("public ModelAndView ");
    String _name_19 = deal.getName();
    ...
    String _firstUpper_15 = StringExtensions.toFirstUpper(_name_20);
    _builder.append(_firstUpper_15, "\t\t\t");
    _builder.append("DoTransition(){");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("ModelAndView mav = new ModelAndView(\"");
    String _name_21 = deal.getName();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("//Deals verschieben");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    State _head_1 = IterableExtensions.<State>head(_transition_1);
    String _name_24 = _head_1.getName();
    String _firstUpper_18 = StringExtensions.toFirstUpper(_name_24);
    _builder.append(_firstUpper_18, "\t\t\t\t");
    _builder.append(" nextState = null;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("List<");
    ...
    _builder.append(_firstUpper_19, "\t\t\t\t");
    _builder.append("> dealsListNext = new ArrayList<");
    ...
    _builder.append("\t\t\t\t");
    String _name_27 = deal.getName();
    String _firstUpper_21 = StringExtensions.toFirstUpper(_name_27);
    _builder.append(_firstUpper_21, "\t\t\t\t");
    String _name_28 = state.getName();
    String _firstUpper_22 = StringExtensions.toFirstUpper(_name_28);
    _builder.append(_firstUpper_22, "\t\t\t\t");
    _builder.append(" state = null;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("List<");
    String _name_29 = deal.getName();
    String _firstUpper_23 = StringExtensions.toFirstUpper(_name_29);
    _builder.append(_firstUpper_23, "\t\t\t\t");
    _builder.append("> dealsList = null;");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.append("if(state.get");
    String _name_30 = deal.getName();
    String _firstUpper_24 = StringExtensions.toFirstUpper(_name_30);
    ...
    _builder.append("dealsList = state.get");
    String _name_31 = deal.getName();
    String _firstUpper_25 = StringExtensions.toFirstUpper(_name_31);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("// Liste war schlicht leer - return.");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("dealsList = new ArrayList<");
    String _name_32 = deal.getName();
    String _firstUpper_26 = StringExtensions.toFirstUpper(_name_32);
    _builder.append(_firstUpper_26, "\t\t\t\t\t\t");
    _builder.append(">();");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("state.set");
    String _name_33 = deal.getName();
    String _firstUpper_27 = StringExtensions.toFirstUpper(_name_33);
    _builder.append(_firstUpper_27, "\t\t\t\t\t\t");
    _builder.append("List(dealsList);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("stateRepository.save(state);");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("mav.addObject(\"deals\", dealsList);");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("state = new ");
    String _name_34 = deal.getName();
    String _firstUpper_28 = StringExtensions.toFirstUpper(_name_34);
    _builder.append(_firstUpper_28, "\t\t\t\t\t");
    String _name_35 = state.getName();
    String _firstUpper_29 = StringExtensions.toFirstUpper(_name_35);
    ...
    _builder.append("dealsList = new ArrayList<");
    String _name_36 = deal.getName();
    String _firstUpper_30 = StringExtensions.toFirstUpper(_name_36);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(nextStateRepository.findAll().iterator().hasNext()){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("nextState = nextStateRepository.findAll().iterator().next();");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("}else{");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("nextState = new ");
    String _name_37 = deal.getName();
    String _firstUpper_31 = StringExtensions.toFirstUpper(_name_37);
    _builder.append(_firstUpper_31, "\t\t\t\t\t");
    EList<State> _transition_2 = state.getTransition();
    State _head_2 = IterableExtensions.<State>head(_transition_2);
    String _name_38 = _head_2.getName();
    String _firstUpper_32 = StringExtensions.toFirstUpper(_name_38);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("dealsListNext = dealsList;");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("dealsList = new ArrayList<");
    String _name_39 = deal.getName();
    String _firstUpper_33 = StringExtensions.toFirstUpper(_name_39);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("nextState.set");
    String _name_40 = deal.getName();
    String _firstUpper_34 = StringExtensions.toFirstUpper(_name_40);
    _builder.append(_firstUpper_34, "\t\t\t\t");
    _builder.append("List(dealsListNext);");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t\t");
    _builder.append("state.set");
    String _name_41 = deal.getName();
    String _firstUpper_35 = StringExtensions.toFirstUpper(_name_41);
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("nextStateRepository.save(nextState);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
  ...
  public CharSequence generateErrorPageJsp(final RentalSystem rentalSystem) {
    StringConcatenation _builder = new StringConcatenation();
    CharSequence _generateJspHeader = this.generateJspHeader(rentalSystem);
    _builder.append(_generateJspHeader, "");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("<h1>An error occured! We are terribly sorry for that. Please start over</h1>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<a href=\"customersIndex\" class=\"btn btn-primary\">Customers</a>");
    _builder.newLine();
  ...
  public CharSequence generateDealStateJsp(final Deal deal, final RentalSystem rentalSystem, final State state) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("<p>Here one could, depending on the Events in the workflow for this");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("state, manipulate the deals, such as deleting, saving, changing etc.</p>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<p>Deals in this state:</p>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<ul>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<c:forEach var=\"j\" items=\"${deals}\">");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<li>${j.id}</li>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</c:forEach>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<p>Following actions will move all deals of this state to the next one:</p>");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    String _firstUpper_2 = StringExtensions.toFirstUpper(_name_3);
    _builder.append(_firstUpper_2, "\t\t");
    _builder.append("MoveDeals\" class=\"btn btn-primary\">Move Deals To Next State</a>");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("<a href=\"");
    String _name_4 = deal.getName();
    ...
    _builder.append(_firstUpper_3, "\t\t");
    _builder.append(" States Index</a>");
    _builder.newLineIfNotEmpty();
    CharSequence _generateJspFooter = this.generateJspFooter(rentalSystem);
    _builder.append(_generateJspFooter, "");
    _builder.newLineIfNotEmpty();
