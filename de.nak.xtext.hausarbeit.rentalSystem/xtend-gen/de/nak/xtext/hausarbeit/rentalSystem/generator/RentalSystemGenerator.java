...
public class RentalSystemGenerator extends AbstractGenerator {
  ...
  public CharSequence generateDealController(final Deal deal, final RentalSystem rentalSystem) {
    ...
    String _firstLower_10 = StringExtensions.toFirstLower(_name_15);
    _builder.append(_firstLower_10, "\t\t\t");
    _builder.append("\");");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
  ...
  public CharSequence buildInput(final Attribute attribute) {
    ...
    if (!_matched) {
      ...
      if (_equals_1) {
        ...
        _builder_1.append("<input type=\"number\" step=\"1\"");
    ...
    if (!_matched) {
      ...
      if (_equals_3) {
        ...
        _builder_3.append("<input type=\"number\" step=\"0.01\"");
  ...
  public CharSequence generateDealFormJsp(final Deal deal, final RentalSystem rentalSystem) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<select name=\"dealCustomer\" size=\"1\" th:field=\"${");
    String _name_8 = deal.getName();
    String _firstLower_7 = StringExtensions.toFirstLower(_name_8);
    _builder.append(_firstLower_7, "\t\t");
    _builder.append(".");
    Customer _customer = deal.getCustomer();
    String _name_9 = _customer.getName();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<option value=\"i\">i.id</option>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</c:forEach>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<select name=\"dealRentalType\" size=\"1\" th:field=\"${");
    String _name_10 = deal.getName();
    String _firstLower_9 = StringExtensions.toFirstLower(_name_10);
    _builder.append(_firstLower_9, "\t\t");
    _builder.append(".");
    RentalType _rentalType = deal.getRentalType();
    String _name_11 = _rentalType.getName();
    String _firstLower_10 = StringExtensions.toFirstLower(_name_11);
    _builder.append(_firstLower_10, "\t\t");
    _builder.append("}\">");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("<c:forEach var=\"j\" items=\"${rentalTypes}\">");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<option value=\"j\">j.id</option>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</c:forEach>");
    _builder.newLine();
    ...
    _builder.append("<a href=\"");
    String _name_12 = deal.getName();
    String _firstLower_11 = StringExtensions.toFirstLower(_name_12);
