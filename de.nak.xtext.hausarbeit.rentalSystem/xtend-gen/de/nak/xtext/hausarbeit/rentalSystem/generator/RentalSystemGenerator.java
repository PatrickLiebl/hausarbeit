...
public class RentalSystemGenerator extends AbstractGenerator {
  ...
  public CharSequence generateDealJsp(final Deal deal, final RentalSystem rentalSystem) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<form id=\"dealState-form\" role=\"form\" th:action=\"@{/");
    String _name_1 = deal.getName();
    String _firstLower = StringExtensions.toFirstLower(_name_1);
    _builder.append(_firstLower, "\t\t");
    RentalWorkflow _rentalWorkflow = deal.getRentalWorkflow();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<input type=\"radio\" name=\"selectedDealId\" value=\"${i.id}\">${i.id}<br />");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</c:forEach>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<button type=\"submit\">Start Deal Workflow</button>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</form>");
    _builder.newLine();
  ...
  public CharSequence generateDealStateJsp(final Deal deal, final RentalSystem rentalSystem, final State state) {
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("<p>SelectedDeal ID: ${selectedDeal.id}</p>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<form method=\"post\" th:action=\"@{/");
    String _name_2 = deal.getName();
    String _firstLower = StringExtensions.toFirstLower(_name_2);
    _builder.append(_firstLower, "\t\t");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    _builder.append("<input type=\"hidden\" name=\"selectedDealId\" value=\"${selectedDeal.id}\">");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<button type=\"submit\">Next</button>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</form>");
    _builder.newLine();
